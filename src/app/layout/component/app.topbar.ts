        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <span>Profile</span>
                    <i class="pi pi-chevron-down ml-2" style="font-size: .8rem"></i>
                    </button>
...
export class AppTopbar {
    ...
    logout() {
        this.auth.logout().subscribe({
            ...
            error: () => this.router.navigateByUrl('/landing'), // still navigate; session already cleared
        });
    }
}
